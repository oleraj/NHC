...
def gene_clustering(cur_index):
	...
	for cur_gene in cur_case_gene_set:
		...
		# cur_case_gene in global_case_gene_visited?
		# Only proceed with unvisited case_gene
		...
		if cur_case_gene not in global_case_gene_visited:
			...
			while checking_index_set:
					...
					if overlapping_gene_set:
						...
						for existing_gene in this_gene_set:
							for checking_gene in checking_gene_set:
								...
								# checking_sample_gene in global_sample_gene_visited?
								# Only proceed with unvisited sample_gene
				...
				if overlap:
					...
					# add closest_case_gene into global_case_gene_visited
					for each_overlapping_gene in overlapping_gene_set:
					...
					# add closest_sample_gene into global_sample_gene_visited
